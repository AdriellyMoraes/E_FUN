    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a class="nav-link js-scroll-trigger" onclick="document.getElementById('id01').style.display = 'block'" style="cursor:pointer">Cadastre-se</a>
                        </li>
                        <li class="nav-item">
        ...
        <section id="contact" class="content-section text-center"  style="height: 70%">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <h2>Entre em contato com E-FUN</h2>
                        <p>Nossa equipe está à disposição nas seguintes plataformas:
